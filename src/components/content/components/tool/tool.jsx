...
import Pro from '../../../../assets/images/tool/pro.png';
import Genius from '../../../../assets/images/tool/genius.png';
import Tools from '../../../../assets/images/tool/tool.png';
import './style.less';
                        ...
                        <div className="col-md-12">
                            ...
                            <ul className="featured-boxes">
                                <li className="featured-boxes-item">
                                    <img src={Tools} className="featured-boxes-item-ico"
                                         alt="Shine Tool 构建工具"/>
                                    ...
                                    <a href="#" className="featured-boxes-item-button button blue stroke rounded"> 了解更多 </a>
                                </li>
                                <li className="featured-boxes-item">
                                    <img src={Pro} className="featured-boxes-item-ico"
                                         alt="Shine Design Pro 解决方案"/>
                                    ...
                                    <a href="#"
                                       className="featured-boxes-item-button button blue stroke rounded"> 了解更多 </a>
                                </li>
                                <li className="featured-boxes-item">
                                    <img src={Genius} className="featured-boxes-item-ico"
                                         alt="Genius Bar 帮助中心"/>
                                    <h5 className="featured-boxes-item-pretitle">帮助中心</h5>
                                    <h4 className="featured-boxes-item-title">Genius Bar</h4>
                                    <p className="featured-boxes-item-description">此刻，与千万开发者一起，获取有关 Shine Design
                                        的技术支持。</p>
                                    <a href="#"
                                       className="featured-boxes-item-button button blue stroke rounded"> 了解更多 </a>
                                </li>
                            </ul>
                            <div className="featured-more helper center">
                                <a href="" className="faq-grid-show-more">更多工具
